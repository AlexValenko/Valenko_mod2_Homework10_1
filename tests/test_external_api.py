...
from src.external_api import get_amount_rub, get_amount_transaction_rub


@pytest.fixture
def normal_transaction_rub() -> dict:
    return {
        "id": 441945886,
        "state": "EXECUTED",
...
@pytest.fixture
def normal_transaction_usd() -> dict:
    return {
        "id": 41428829,
        "state": "EXECUTED",
...
@pytest.fixture
def get_standard_response() -> dict:
    return {
        "date": "2026-05-08",
        "info": {"rate": 74.651554, "timestamp": 1778222583},
        "query": {"amount": 200, "from": "USD", "to": "RUB"},
        "result": 14930.3108,
        "success": True,
    }
