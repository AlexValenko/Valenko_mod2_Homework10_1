...
def first_transactions():
    return [
        {'id': '650703', 'state': 'EXECUTED', 'date': '2023-09-05T11:30:32Z', 'operationAmount': {
            'amount': '16210', 'currency': {'name': 'Sol', 'code': 'PEN'}},
         'description': 'Перевод организации',
         'from': 'Счет 58803664561298323391',
         'to': 'Счет 39745660563456619397'},
{'id': '3598919', 'state': 'EXECUTED', 'date': '2020-12-06T23:00:58Z', 'operationAmount': {'amount': '29740', 'currency': {'name': 'Peso', 'code': 'COP'}}, 'description': 'Перевод с карты на карту', 'from': 'Discover 3172601889670065', 'to': 'Discover 0720428384694643'},
{'id': '593027', 'state': 'CANCELED', 'date': '2023-07-22T05:02:01Z', 'operationAmount': {'amount': '30368', 'currency': {'name': 'Shilling', 'code': 'TZS'}}, 'description': 'Перевод с карты на карту', 'from': 'Visa 1959232722494097', 'to': 'Visa 6804119550473710'}
]

def test_get_transaction_from_csv_normal(first_transactions) -> None:
...
def test_get_transaction_from_csv_incorrect_data(capsys) -> None:
    """Пример работы функции get_transaction_from_csv с некорректными данными"""
    mock_incorrect_data = [
        {'name': 'Rent', 'date': '2023-01-15'},
        {'name': 'Salary', 'date': '2023-01-20'}
    ]
...
def test_get_transaction_from_csv_decode_error(capsys) -> None:
...
def test_get_transaction_from_excel_normal(first_transactions) -> None:
...
def test_get_transaction_from_excel_not_file(capsys) -> None:
...
def test_get_transaction_from_excel_decode_error(capsys) -> None:
