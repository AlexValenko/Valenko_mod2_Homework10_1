...
def test_filter_by_currency_usd(example_transactions, usd_filtered_transactions):
...
def test_filter_by_currency_rub(example_transactions, rub_filtered_transactions):
...
def test_transaction_descriptions_norm(example_transactions):
    gen_decriptions = transaction_descriptions(example_transactions)
    assert next(gen_decriptions) == "Перевод организации"
    assert next(gen_decriptions) == "Перевод со счета на счет"

def test_transaction_descriptions_empty():
    gen_decriptions = transaction_descriptions([])
    assert next(gen_decriptions) == []

def test_card_number_generator_norm():
